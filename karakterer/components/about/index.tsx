                        ...
                        items={[
                            {
                                ...
                                content: (
                                    <Typography variant="body1" style={{ lineHeight: 1.5 }}>
                                        Data rapporteres inn to ganger årlig; etter høstsemesteret
                                        og etter vårsemesteret. Det er forskjellig fra emne til emne
                                        hvordan karakterer for konteeksamen rapporteres inn og om de
                                        blir aggregert med karakterer for ordinær eksamen eller
                                        ikke.
                                    </Typography>
                                )
                            },
                            {
                                ...
                                content: (
                                    <>
                                        <Typography variant="body1" style={{ lineHeight: 1.5 }}>
                                            NTNU har følgende frister for innrapportering til
                                            HK-dir:
                                        </Typography>
                                        <List>
                                            <li>
                                        ...
                                        <Typography variant="body1" style={{ lineHeight: 1.5 }}>
                                            Statistikken oppdateres innen kort tid etter disse
                                            fristene, gitt at dataen er rapportert inn og
                                            tilgjengelig.
                                        </Typography>
                                    </>
                                )
                            },
                            {
                                ...
                                content: (
                                    <>
                                        <Typography variant="body1" style={{ lineHeight: 1.5 }}>
                                            Totalt gjennomsnitt tar utgangspunkt i følgende verdier
                                            for karakterer:
                                        </Typography>
                                        <ListContainer>
                                            <List>
                            ...
                            },
                            {
                                ...
                                content: (
                                    <Typography variant="body1" style={{ lineHeight: 1.5 }}>
                                        Totalt strykprosent regnes ut ved å summere antall studenter
                                        som fikk stryk for alle semestrene, dele på totalt antall
                                        studenter og gange med 100.
                                    </Typography>
                                )
                            }
                        ]}
